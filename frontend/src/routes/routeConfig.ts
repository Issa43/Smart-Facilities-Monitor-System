    ...
    nav: [
      {
        ...
        items: [
          ...
          { path: '/admin/material-requests', label: 'طلبات المواد', icon: 'materialRequests' },
      ...
      },
      {
        ...
        items: [
          ...
          { path: '/operations/assets', label: 'الأصول', icon: 'assets' },
          { path: '/operations/work-orders', label: 'الصيانة', icon: 'maintenance' },
          { path: '/security/alerts', label: 'التنبيهات', icon: 'securityAlert' },
          { path: '/operations/safety-alerts', label: 'الإنذارات والسلامة', icon: 'emergency' },
          { path: '/security/incidents', label: 'الحوادث', icon: 'incidents' },
          { path: '/security/cameras', label: 'حالة الكاميرات', icon: 'camera' },
          { path: '/security/events', label: 'أحداث الكاميرات', icon: 'eventLog' },
          { path: '/security/documents', label: 'وثائق السلامة', icon: 'documents' },
        ],
      },
      {
        title: 'النظام',
        items: [
          ...
          { path: '/admin/ai-camera-configuration', label: 'تهيئة كاميرات AI', icon: 'camera' },
        ],
      },
    ],
  },
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { path: '/construction/reports', label: 'مركز التقارير', icon: 'reports' },
