...
/**
 * The table used by every list page. It sorts the records supplied by the
 * API-backed query; high-volume screens can additionally drive server-side
 * ordering and pagination through their query state.
 */
  ...
  const body = (
    <>
      ...
      {pagination && pagination.totalPages > 1 ? (
        <nav className={styles.pagination} aria-label="التنقل بين صفحات الجدول">
          <span className={styles.pageSummary}>
            الصفحة {pagination.page} من {pagination.totalPages} — {pagination.totalItems} سجل
          </span>
