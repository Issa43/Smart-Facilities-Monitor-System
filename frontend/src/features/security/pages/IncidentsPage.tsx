...
const FILTERS: { value: StatusFilter; label: string }[] = [
  ...
  { value: 'transferred', label: 'محول إلى التشغيل' },
    ...
    <>
      ...
      <Section>
        <KpiGrid cols={4}>
          ...
          <KpiCard
            label="تتطلب إجراءً"
            value={formatNumber(incidents.filter((i) => i.status === 'transferred').length)}
            icon="emergency"
            tone="critical"
            loading={incidentsQuery.isPending}
          />
              ...
              >
                ...
                <div className={styles.cardBody}>
                  <div className={styles.cardHead}>
                    <h3 className={styles.cardTitle}>{alertTypeLabel(incident.type)}</h3>
