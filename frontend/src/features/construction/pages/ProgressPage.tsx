...
export function ProgressPage() {
  ...
  const dataError = [projectsQuery, stagesQuery, statsQuery].find((query) => query.isError)?.error
  ...
  return (
    <>
      ...
      <Section>
        <Panel title="منحنى الإنجاز التراكمي" subtitle="متوسط نسب التقدم المسجلة عبر مشاريعك">
