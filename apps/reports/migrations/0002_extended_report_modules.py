...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(model_name="report", name="module", field=models.CharField(choices=CHOICES, max_length=20)),
        migrations.AlterField(model_name="reporttemplate", name="module", field=models.CharField(choices=CHOICES, max_length=20)),
